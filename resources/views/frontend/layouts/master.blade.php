...
<head>
    ...
    <meta name="description" content="Shekh Mohsin is a developers, content writer, cleaner, programmer, Influencer and freelancers. Fully responsive, SEO-friendly, Bootstrap and easy to customize.">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend-assets/images/favicon.svg') }}">
    <title>Shekh Mohsin - Portfolio | Professional Web Developer</title>
    <!-- Bootstrap min css -->
