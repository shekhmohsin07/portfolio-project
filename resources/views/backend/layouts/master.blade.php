...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Shekh Mohsin - Dashboard</title>            
        ...
        <!-- CSS INCLUDE -->        
        <link rel="stylesheet" type="text/css" id="theme" href="{{ asset('backend-assets/css/theme-default.css') }}"/>
        <!-- EOF CSS INCLUDE -->                                      
    </head>
    <body>
        ...
        <!-- START PRELOADS -->
        <audio id="audio-alert" src="{{ asset('backend-assets/audio/alert.mp3') }}" preload="auto"></audio>
        <audio id="audio-fail" src="{{ asset('backend-assets/audio/fail.mp3') }}" preload="auto"></audio>
        <!-- END PRELOADS -->                  
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="{{ asset('backend-assets/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js') }}"></script>
        ...
        <script type="text/javascript" src="{{ asset('backend-assets/js/plugins/rickshaw/d3.v3.js') }}"></script>
        <script type="text/javascript" src="{{ asset('backend-assets/js/plugins/rickshaw/rickshaw.min.js') }}"></script>
        <script type='text/javascript' src="{{ asset('backend-assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
        <script type='text/javascript' src="{{ asset('backend-assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>                
        <script type='text/javascript' src="{{ asset('backend-assets/js/plugins/bootstrap/bootstrap-datepicker.js') }}"></script>                
