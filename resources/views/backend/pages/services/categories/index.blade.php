...
<div class="container-fluid py-4 ">
    ...
    <!-- Header -->
    <div class="d-flex flex-wrap justify-content-between mb-4" style="margin-top: 60px !important;">
        ...
        <div class="row">
                ...
                <div class="col-md-9 mb-3 mb-md-0">
                    ...
                    <p class="text-muted mb-0">
                        Manage all your service categories easily.
                    </p>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="d-flex align-items-center gap-2"">
                                    ...
                                    <!-- Edit Button -->
                                    <a href="{{ route('service-categories.edit', $category->slug) }}"
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('service-categories.destroy', $category->slug) }}"
                                        method="POST"
